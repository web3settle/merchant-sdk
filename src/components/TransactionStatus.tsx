...
const ORDERED_STATUSES: readonly PaymentStatus[] = [
...
function getStepState(
  ...
  const stepIndex = ORDERED_STATUSES.indexOf(stepStatus);
...
export function TransactionStatus({
  ...
  if (status === PaymentStatus.Error) {
    return (
      <div
        role="alert"
        className="w3s-flex w3s-flex-col w3s-items-center w3s-gap-4 w3s-py-6"
      >
